	...
	while(bool){
		...
		switch(choice){
			...
			case 10:
				...
				break;
            case 11:
				printf("Sposob odwrocenia listy:\n");
                printf("    1. Iteracyjnie\n");
                printf("    2. Rekurencyjnie\n");
                printf("Twoj wybor: ");
                scanf("%d", &x);
                if(x == 1) lista = reverseIt(lista);
                else if(x == 2) lista = reverseRec(lista);
				clear_screen();
				break;
			case 0:
				bool = 0;
