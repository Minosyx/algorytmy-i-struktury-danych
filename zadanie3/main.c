...
void printOptions()
{
    ...
    printf("11 - znajdz najczesciej wystepujaca wartosc\n");
...
int main()
{
    ...
    while (bool)
    {
        ...
        case 10:
            ...
            break;
        case 11:
            printf("W przypadku takiej samej liczby wystapien wielu liczb zwracana jest pierwsza z nich!\n\n");
            if(lista){
                x = mostOccur(lista);
                printf("Najczesciej wystepujaca wartoscia jest: %d\n\n", x);
            }
